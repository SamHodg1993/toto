...
func init() {
	...
	projAddCmd.PersistentFlags().StringVarP(&projectTitle, "title", "t", "", "Title of the todo")
	projAddCmd.PersistentFlags().StringVarP(&projectDescription, "description", "d", "", "Description of the todo")
	projAddCmd.PersistentFlags().StringVarP(&projectCreatedAt, "created-at", "c", "", "Todo creation time")
	projAddCmd.PersistentFlags().StringVarP(&projectUpdatedAt, "updated-at", "u", "", "Todo last updated time")
	projAddCmd.PersistentFlags().IntVarP(&projectArchived, "archived", "a", 0, "Relevent Project Id")
